...
router.get('/', (req, res, next) => {
  ...
  return productsServices.getProducts(requestOptions).then((result) => {
...
router.post('/', (req, res, next) => {
  ...
  return productsServices.addProduct(requestOptions).then((result) => {
    res.status(result.status || httpStatus.OK).send(result.data);
  }).catch(err => res.status(httpStatus.INTERNAL_SERVER_ERROR).send(
    {
      status: httpStatus.INTERNAL_SERVER_ERROR,
...
router.get('/:id', (req, res, next) => {
  ...
  return productsServices.getProductById(requestOptions).then((result) => {
    res.status(result.status || httpStatus.OK).send(result.data);
  }).catch(err => res.status(httpStatus.INTERNAL_SERVER_ERROR).send(
    {
      status: httpStatus.INTERNAL_SERVER_ERROR,
...
router.put('/:id', (req, res, next) => {
  ...
  return productsServices.updateProduct(requestOptions).then((result) => {
    res.status(result.status || httpStatus.OK).send(result.data);
  }).catch(err => res.status(httpStatus.INTERNAL_SERVER_ERROR).send(
    {
      status: httpStatus.INTERNAL_SERVER_ERROR,
...
router.delete('/:id', (req, res, next) => {
  ...
  return productsServices.deleteProduct(requestOptions).then((result) => {
    res.status(result.status || httpStatus.OK).send(result.data);
  }).catch(err => res.status(httpStatus.INTERNAL_SERVER_ERROR).send(
    {
      status: httpStatus.INTERNAL_SERVER_ERROR,
